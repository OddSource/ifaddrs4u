...
public:
    ...
    {
        assert_equals( static_cast< ::std::string >( MacAddress( "a4:83:e7:2e:a1:67" ) ), "a4:83:e7:2e:a1:67" );
        assert_equals(
            ::strcmp(
                static_cast< char const * >( MacAddress( "b2:fb:b8:5b:84:e8:ff" ) ),
                "b2:fb:b8:5b:84:e8:ff" ),
            0,
    ...
    test_data_round_trip()
    {
        ...
        static constexpr uint8_t data1[ 6 ] { 0xa4, 0xe7, 0x83, 0xa1, 0x2e, 0x67 };
        static constexpr uint8_t data2[ 7 ] { 0xb2, 0xb8, 0xfb, 0x84, 0x5b, 0xff, 0xe8 };

        {
            MacAddress const address( data1, 6 );
            assert_equals( static_cast< ::std::string >( address ), "a4:e7:83:a1:2e:67" );
        ...
        {
            MacAddress const address( data2, 7 );
            assert_equals( static_cast< ::std::string >( address ), "b2:b8:fb:84:5b:ff:e8" );
    ...
    test_construct_malformed()
    {
        ...
        static constexpr uint8_t data1[ 5 ] { 0xa4, 0xe7, 0x83, 0xa1, 0x2e };
        static constexpr uint8_t data2[ 9 ] { 0xb2, 0xb8, 0xfb, 0x84, 0x5b, 0xff, 0xe8, 0xe7, 0xbb };

        assert_throws( MacAddress( data1, 5 ), ::std::invalid_argument );
        assert_throws( MacAddress( data2, 9 ), ::std::invalid_argument );
    }
